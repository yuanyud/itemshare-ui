<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="跑腿人ID" prop="runnerId">
        <el-input
          v-model="queryParams.runnerId"
          placeholder="请输入跑腿人ID"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['itemshare:service:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['itemshare:service:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['itemshare:service:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['itemshare:service:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="跑腿人ID" prop="runnerId">
          <el-input v-model="form.runnerId" placeholder="请输入跑腿人ID" />
        </el-form-item>
        <el-form-item label="服务时间" prop="serviceTime">
          <el-date-picker clearable
        ...
        <el-form-item label="服务费用" prop="serviceFee">
          <el-input v-model="form.serviceFee" placeholder="请输入服务费用" />
        </el-form-item>
...
<script>
import { listService, getService, delService, addService, updateService } from "@/api/itemshare/service";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        runnerId: [
          { required: true, message: "跑腿人ID不能为空", trigger: "blur" }
        ],
        serviceTime: [
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除跑腿服务管理编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('itemshare/service/export', {
        ...this.queryParams
