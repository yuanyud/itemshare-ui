<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="承租人学生ID" prop="studentId">
        <el-input
          v-model="queryParams.studentId"
          placeholder="请输入承租人学生ID"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="出租人学生ID" prop="landlordId">
        <el-input
          v-model="queryParams.landlordId"
          placeholder="请输入出租人学生ID"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['itemshare:transaction:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['itemshare:transaction:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['itemshare:transaction:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['itemshare:transaction:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="transactionList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="承租人学生ID" align="center" prop="studentId" />
      <el-table-column label="出租人学生ID" align="center" prop="landlordId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="承租人学生ID" prop="studentId">
          <el-input v-model="form.studentId" placeholder="请输入承租人学生ID" />
        </el-form-item>
        <el-form-item label="出租人学生ID" prop="landlordId">
          <el-input v-model="form.landlordId" placeholder="请输入出租人学生ID" />
        </el-form-item>
        <el-form-item label="开始时间" prop="startTime">
          <el-date-picker clearable
...
<script>
import { listTransaction, getTransaction, delTransaction, addTransaction, updateTransaction } from "@/api/itemshare/transaction";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        studentId: [
          { required: true, message: "承租人学生ID不能为空", trigger: "blur" }
        ],
        landlordId: [
          { required: true, message: "出租人学生ID不能为空", trigger: "blur" }
        ],
        startTime: [
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除交易管理编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('itemshare/transaction/export', {
        ...this.queryParams
